...
def hand_rank(hand):
    ...
    return ((8, face_values) if is_flush(hand) and is_straight(hand) else
            ...
            (6, kind(face_values, 3), kind(face_values, 2)) if  kind(face_values, 3) and kind(face_values, 2) else
            ...
            (2, kind(face_values, 2), kind(sorted(face_values), 2), face_values) if kind(face_values, 2) and kind(sorted(face_values), 2) else
